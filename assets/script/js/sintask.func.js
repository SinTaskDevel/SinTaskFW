...
fadeContentTwo = function(message, status, hideIn) {
    var fadeTime = 200;
 ...
 * Alias Toast1 & 2
 */
toastOne = function(message, fadeTime, status) {
    fadeContentOne(message, fadeTime, status);
}
toastTwo = function(message, status, hideIn) {
 ...
 */
sintaskHideNotParamClicked = function(param, callback, fadeTime) {
